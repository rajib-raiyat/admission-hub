...
university = [
    {
        ...
        'university_intro': 'BSMRSTU, known as Bangabandhu Sheikh Mujibur Rahman Science and Technology University,'
                            'is a public university in Gopalganj. The institution was founded in 2001 with an emphasis'
                            ' on education and research in science and technology. With numerous active research '
                            'initiatives and partnerships with other universities and research institutions, '
                            'BSMRSTU maintains a strong focus on research.'
    },
    {
        ...
        'university_intro': 'Dhaka University is a renowned institution of higher education in South Asia, '
                            'known for its academic excellence, research capabilities, and cultural significance. '
                            'It offers undergraduate and postgraduate programs in various fields of study, '
                            'including arts, sciences, business, engineering, law, and medicine.'
    },
    {
        ...
        'university_intro': 'The University of Rajshahi is one of the largest public co-educational research '
                            'university in Bangladesh situated near the northern region. It is known for its '
                            'active research culture, with several research centers and institutes, and has made '
                            'significant contributions to the advancement of knowledge in various fields.'
    },
    {
        ...
        'university_intro': 'Chittagong University is one of the most prestigious and oldest institutions of '
                            'higher learning in Bangladesh.  The institution is known for its beautiful campus, '
                            'academic excellence, research facilities, and contribution to the development of '
    ...
    },
    {
        ...
        'university_intro': 'Jahangirnagar University is a prestigious public research university located in Savar, '
                            'Bangladesh. Established in 1970, the university is named after the Mughal Emperor '
                            'Jahangir. Jahangirnagar University is known for its picturesque campus, vibrant student'
                            ' community, and strong commitment to social justice and environmental sustainability.'
    },
    {
        ...
        'university_intro': 'Khulna University is a public university located in Khulna, a southwestern city of Bangladesh.'
                            'The university offers undergraduate and postgraduate programs in various fields of study, '
                            'including science, engineering, social sciences, and humanities. '
    },
    {
        ...
        'university_intro': 'The National University of Bangladesh is a public university of Bangladesh that was '
                            'established by an Act of Parliament as an affiliating University of the country to impart '
                            'graduate and post-graduate level education to the students through its affiliated colleges'
                            'and professional institutions throughout the country. It is the fourth largest university '
                            'in the world according to enrollment. '
    },
    {
        ...
        'university_intro': 'Bangladesh Agricultural University, also known as BAU, is a public agricultural university'
                            'located in Mymensingh. Crop science, soil science, animal science, fisheries and agricultural'
                            'engineering are a few of the study areas linked to agriculture that the institution offers'
